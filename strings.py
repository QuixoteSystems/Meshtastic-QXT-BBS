...
UTILITIES_MENU = ":: MENU DE UTILIDADES ::\n"
...
BULLETIN_MENU = ":: MENU DE BOLETINES ::\nA que Boletin quieres entrar?\n [G]eneral\n [I]nfo\n [N]oticias\n [U]rgente"
...
#MESSAGE = " messages"
MESSAGES = " mensajes"
#SELECT_BULLETIN = "Select a bulletin number to view from "
SELECT_BULLETIN = "Elige el numero del Boletin que quieres ver de "
